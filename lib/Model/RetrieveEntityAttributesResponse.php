...
/**
 * RetrieveEntityAttributesResponse Class Doc Comment
 *
 * @category Class
 * @package  Dounasth\Ngsiv2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RetrieveEntityAttributesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RetrieveEntityAttributesResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['humidity'] === null) {
            $invalidProperties[] = "'humidity' can't be null";
        }
