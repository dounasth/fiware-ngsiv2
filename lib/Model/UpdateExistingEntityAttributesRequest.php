...
/**
 * UpdateExistingEntityAttributesRequest Class Doc Comment
 *
 * @category Class
 * @package  Dounasth\Ngsiv2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateExistingEntityAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateExistingEntityAttributesRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['seat_number'] === null) {
            $invalidProperties[] = "'seat_number' can't be null";
        }
